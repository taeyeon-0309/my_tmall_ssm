package com.iu2java.tmall.util;
...
public class MybatisGenerator {
    ...
    public static void main (String[] args) throws Exception{
        ...
        InputStream is = com.iu2java.tmall.util.MybatisGenerator.class.getClassLoader().getResource("generatorConfig.xml").openStream();//获取配置文件对应路径的输入流
